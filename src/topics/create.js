...
module.exports = function (Topics) {
    Topics.create = function (data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            plugins.hooks.fire('action:topic.save', { topic: lodash_1.default.clone(topicData), data: data });
    ...
    Topics.post = function (data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!data.fromQueue) {
                yield user.isReadyToPost(uid, data.cid);
            }
    ...
    Topics.reply = function (data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            plugins.hooks.fire('action:topic.reply', { post: lodash_1.default.clone(postData), data: data });
            return postData;
        });
    };
    ...
    function guestHandleValid(data) {
        return __awaiter(this, void 0, void 0, function* () {
            if (meta.config.allowGuestHandles && parseInt(data.uid, 10) === 0 && data.handle) {
                ...
                const exists = yield user.existsBySlug(slugify(data.handle));
                if (exists) {

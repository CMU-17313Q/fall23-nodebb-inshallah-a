<div component="composer" class="composer<!-- IF resizable --> resizable<!-- ENDIF resizable --><!-- IF !isTopicOrMain --> reply<!-- ENDIF !isTopicOrMain -->"<!-- IF !disabled --> style="visibility: inherit;"<!-- ENDIF !disabled -->>
	...
	<div class="composer-container">
		<form id="compose-form" method="post">
			...
			<input type="text" name="isPrivate" id="isPrivate" value="false" />
    		<input type="text" name="isAnonymous" id="isAnonymous" value="false" />
		</form>
		<div data-component="composer/identity-selector" class="identity-selector-container">
			...
			<!-- Adding isPrivate attribute -->
			<label for="isPrivateSelect" style="margin-left: 10px;">Visibility:</label>
			<select id="isPrivateSelect" name="isPrivate" class="form-control" style="width: auto; display: inline-block; margin-left: 5px;">
				<option value="false">Public</option>
				<option value="true">Private</option>
			</select>
			<!-- End of isPrivate attribute addition -->
		</div>

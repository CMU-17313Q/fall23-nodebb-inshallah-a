<div component="composer" class="composer<!-- IF resizable --> resizable<!-- ENDIF resizable --><!-- IF !isTopicOrMain --> reply<!-- ENDIF !isTopicOrMain -->">
	...
	<div class="urgentB">
    <button onclick="alert('You have marked this post as URGENT!')" class="urgentButton" style="text-align: center; border-radius: 10%; font-family: 'Verdana'; color: white; background-color: red; border: 3.5px solid #800000; font-size: 15.5px;"  >Mark this post as URGENT</button>
	</div>

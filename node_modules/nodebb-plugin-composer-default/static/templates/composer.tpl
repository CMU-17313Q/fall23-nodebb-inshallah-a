<div component="composer" class="composer<!-- IF resizable --> resizable<!-- ENDIF resizable --><!-- IF !isTopicOrMain --> reply<!-- ENDIF !isTopicOrMain -->">
	...
	<div class="composer-container">
		...
		<div data-component="composer/identity-selector" class="identity-selector-container">
	<!-- Anonymous or Username Dropdown -->
	<label for="isAnonymous" style="margin-right: 10px;">Identity:</label>
	<select id="isAnonymous" name="isAnonymous" class="form-control" style="width: auto; display: inline-block; margin-right: 5px;">
		<option value="false">Username</option>
		<option value="true">Anonymous</option>
	</select>

	<!-- Private or Public Dropdown -->
	<label for="isPrivate" style="margin-left: 10px;">Visibility:</label>
	<select id="isPrivate" name="isPrivate" class="form-control" style="width: auto; display: inline-block; margin-left: 5px;">
		...
		<div class="row title-container">
			...
			<div data-component="composer/title">
				<!-- IF isTopicOrMain -->
				<input class="title form-control" type="text" tabindex="1" placeholder="[[topic:composer.title_placeholder]]" value="{isAnonymous}"/>

<div component="composer" class="composer<!-- IF resizable --> resizable<!-- ENDIF resizable --><!-- IF !isTopicOrMain --> reply<!-- ENDIF !isTopicOrMain -->">
	...
	<div class="composer-container">
		...
		<div class="urgentButton">
   		 <button class="urgentButton">mark this post as URGENT</button>
		</div>

		<div onclick="alert('Div Clicked!')" class="button-style">Div Button</div>
		<span onclick="alert('Span Clicked!')" class="button-style">Span Button</span>

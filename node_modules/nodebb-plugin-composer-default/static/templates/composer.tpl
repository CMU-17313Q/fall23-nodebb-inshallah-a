<div component="composer" class="composer<!-- IF resizable --> resizable<!-- ENDIF resizable --><!-- IF !isTopicOrMain --> reply<!-- ENDIF !isTopicOrMain -->">
	...
	<div class="urgentB">
    <button id="urgentButton" class="button-urgent">Mark this post as URGENT!</button>
    <div onclick="alert('You have marked this post as URGENT!')" class="button-urgent">Div Button</div>
		</div>

<div component="composer" class="composer<!-- IF resizable --> resizable<!-- ENDIF resizable --><!-- IF !isTopicOrMain --> reply<!-- ENDIF !isTopicOrMain -->">
	<div class="composer-container">
		...
		<div data-component="composer/identity-selector" class="identity-selector-container">
			...
			<label for="isAnonymousSelect" style="margin-right: 10px;">Identity:</label>
	...
	<input type="hidden" id="isUrgentInput" value="false">
	<div class="urgentB">
    <button onclick="document.getElementById('isUrgentInput').value = 'true'; alert('You have marked this post as URGENT!');" class="urgentButton" style="text-align: center; border-radius: 10%; font-family: 'Verdana'; color: white; background-color: red; border: 3.5px solid #800000; font-size: 15.5px;">Mark this post as URGENT</button>
	</div>
